...
package com.cn.henry.generate.modular.param;

import com.cn.henry.core.pojo.base.param.BaseParam;
import com.cn.henry.core.validation.flag.FlagValue;
import lombok.Data;
...
public class CodeGenerateParam extends BaseParam {
     ...
     * 是否移除表前缀
     */
    @NotBlank(message = "是否移除表前缀不能为空，请检查tablePrefix参数", groups = {add.class, edit.class})
     ...
     * 生成方式
     */
    @NotBlank(message = "生成方式不能为空，请检查generateType参数", groups = {add.class, edit.class})
