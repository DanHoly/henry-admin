package com.cn.henry.generate.core.config;
...
public class Config {
     ...
     * 大模块名称（生成到代码中哪个模块下）
     */
    public static String BASE_MODULAR_NAME = "henry-base" + FILE_SEP + "henry-system";
    ...
    public static String[] xnCodeGenFilePath (String busName, String packageName) {
        ...
        manageJsPath = BASE_VUE_PAHT + FILE_SEP + "api" + FILE_SEP + MODULAR_NAME + FILE_SEP + "system" + FILE_SEP;
        vueIndexPath = BASE_VUE_PAHT + FILE_SEP + "views" + FILE_SEP + "system" + FILE_SEP + busName + FILE_SEP;
        vueAddFromPath = BASE_VUE_PAHT + FILE_SEP + "views" + FILE_SEP + "system" + FILE_SEP + busName + FILE_SEP;
        vueEditFromPath = BASE_VUE_PAHT + FILE_SEP + "views" + FILE_SEP + "system" + FILE_SEP + busName + FILE_SEP;
        return new String[] {
