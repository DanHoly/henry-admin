 ...
 */
package com.cn.henry.sys.modular.debt.enums;
...
public enum DebtExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        DebtExceptionEnum(Integer code, String message) {
        this.code = code;
