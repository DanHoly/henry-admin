 ...
 */
package com.cn.henry.sys.modular.auth.service.impl;
...
import com.cn.henry.sys.core.jwt.JwtPayLoad;
import com.cn.henry.sys.core.jwt.JwtTokenUtil;
import com.cn.henry.sys.core.log.LogManager;
import com.cn.henry.sys.modular.auth.factory.LoginUserFactory;
import com.cn.henry.core.consts.CommonConstant;
import com.cn.henry.core.context.constant.ConstantContextHolder;
import com.cn.henry.core.dbs.CurrentDataSourceContext;
import com.cn.henry.core.enums.CommonStatusEnum;
import com.cn.henry.core.exception.AuthException;
import com.cn.henry.core.exception.ServiceException;
import com.cn.henry.core.exception.enums.AuthExceptionEnum;
import com.cn.henry.core.exception.enums.ServerExceptionEnum;
import com.cn.henry.core.pojo.login.SysLoginUser;
import com.cn.henry.core.tenant.context.TenantCodeHolder;
import com.cn.henry.core.tenant.context.TenantDbNameHolder;
import com.cn.henry.core.tenant.entity.TenantInfo;
import com.cn.henry.core.tenant.exception.TenantException;
import com.cn.henry.core.tenant.exception.enums.TenantExceptionEnum;
import com.cn.henry.core.tenant.service.TenantInfoService;
import com.cn.henry.core.util.HttpServletUtil;
import com.cn.henry.core.util.IpAddressUtil;
import com.cn.henry.sys.core.cache.UserCache;
import com.cn.henry.sys.core.enums.LogSuccessStatusEnum;
import com.cn.henry.sys.modular.auth.service.AuthService;
