...
import com.cn.henry.sys.core.mybatis.dbid.XiaoNuoDatabaseIdProvider;
import com.cn.henry.sys.core.mybatis.fieldfill.CustomMetaObjectHandler;
import com.cn.henry.sys.core.mybatis.sqlfilter.DemoProfileSqlInterceptor;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.cn.henry.**.mapper"})
