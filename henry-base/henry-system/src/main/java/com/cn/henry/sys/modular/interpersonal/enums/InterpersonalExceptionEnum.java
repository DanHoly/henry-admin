 ...
 */
package com.cn.henry.sys.modular.interpersonal.enums;
...
public enum InterpersonalExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        InterpersonalExceptionEnum(Integer code, String message) {
        this.code = code;
