...
import com.cn.henry.core.annotion.Wrapper;
import com.cn.henry.core.consts.AopSortConstant;
import com.cn.henry.core.exception.ServiceException;
import com.cn.henry.core.exception.enums.WrapperExceptionEnum;
import com.cn.henry.core.pojo.base.wrapper.BaseWrapper;
...
public class WrapperAop {
     ...
     * @date 2020/7/24 17:42
     */
    @Pointcut("@annotation(com.cn.henry.core.annotion.Wrapper)")
