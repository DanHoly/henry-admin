    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          has-feedback
        >
          <a-input placeholder="请输入债务类型欠债1,借出2" v-decorator="['debtType', {rules: [{required: true, message: '请输入债务类型欠债1,借出2！'}]}]" />
        </a-form-item>
        <a-form-item
          label="金额"
          :labelCol="labelCol"
...
<script>
  import { debtEdit } from '@/api/modular/system/debtManage'
  export default {
    data () {
      return {
        labelCol: {
